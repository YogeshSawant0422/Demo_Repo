<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewBook.aspx.cs" Inherits="BooksManagement.AddNewBook" %>
       ...
       <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm p-3 min-vh-100">
                    <div class="card">
                        <h3 class="card-header">Add New Book</h3>
                        <div class="card-body">
                                        ...
                                        <div style="padding: 5px">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <asp:TextBox runat="server" ID="BookName" CssClass="form-control"  placeholder="Book Name" ></asp:TextBox>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="AutherName" class="form-label">Author Name</label>
                                                    <asp:DropDownList runat="server" OnSelectedIndexChanged="Auther_SelectedIndexChanged" AutoPostBack="true" ID="Auther" CssClass="form-control">
                                            ...
                                            <div class="row" style="margin-top:20px;">
                                                <div class="col-md-6">
                                                    <label for="Date" class="form-label">Book Publish Date</label>
                                                    <asp:TextBox runat="server" type="date" CssClass="form-control" ID="Date"></asp:TextBox>
                                                </div>
                                                <div class="col-md-6">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <asp:Button ID="AddBook" OnClick="AddBook_Click" Text="Add Book" CssClass="btn btn-success" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
